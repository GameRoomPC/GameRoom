...
public class ActivationKeyDialog extends GameRoomDialog{
    ...
    public ActivationKeyDialog(){
        ...
        ButtonType buyButton = new ButtonType(com.gameroom.ui.Main.getString("more_infos")+"!", ButtonBar.ButtonData.LEFT);
        ButtonType cancelButton = new ButtonType(com.gameroom.ui.Main.getString("cancel"), ButtonBar.ButtonData.CANCEL_CLOSE);
