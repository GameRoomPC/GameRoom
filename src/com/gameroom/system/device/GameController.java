...
public class GameController {
     ...
     * should be called whenever the window loses focus, see {@link com.gameroom.ui.dialog.WindowFocusManager#windowFocused}
     */
    public void pause() {
        pollingTask.stop();
     ...
     * should be called whenever the window gains focus, see {@link com.gameroom.ui.dialog.WindowFocusManager#windowFocused}
     */
    public void resume() {
        emptyQueue();
    ...
    /**
     * Called when polling occurs, this will use com.gameroom.data from the {@link Component} of the {@link #controller} to perform
     * actions defined by the {@link #controllerButtonListener}.
     *
     * @param component  the component from where the com.gameroom.data comes from
