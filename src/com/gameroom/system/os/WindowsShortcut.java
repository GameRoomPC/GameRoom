...
public class WindowsShortcut
{
     ...
     * @throws IOException if an IOException is encountered while reading the com.gameroom.data from the InputStream
     */
    ...
    /**
     * Gobbles up link com.gameroom.data by parsing it and storing info in member fields
    ...
    private void parseLink(byte[] link) throws ParseException {
        try {
            ...
            // get the local volume and local com.gameroom.system values
