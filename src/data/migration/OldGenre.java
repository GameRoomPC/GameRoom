...
public enum OldGenre {
    ...
    private final static HashMap<Integer, OldGenre> IGDB_GENRE_MAP = new HashMap<>();
    private String key;
    ...
    public static OldGenre getGenreFromIGDB(int igdbGenreId) {
    ...
    public static HashMap<Integer, OldGenre> getIgdbGenreMap() {
