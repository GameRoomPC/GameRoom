...
public class YoutubeSoundtrackScrapper {
    ...
    public static String getThemeYoutubeHash(GameEntry entry) throws IOException, UnirestException {
        ...
        for(String keywords : SOUNDTRACK_KEY_WORDS){
            videoMetadatas.addAll(getVideosTitlesAndLinksFor(entry.getName(),keywords));
        }
    ...
    private static void rankSoundtrackResults(ArrayList<VideoMetadata> videoMetadatas, String gameName){
        ...
        if(DEBUG){
            Main.LOGGER.debug("Found videos : ");
    ...
    public static class VideoMetadata{
        private final static String TAG_EMBEDDED = "embed";
        private final static String TAG_WATCH = "watch";
        private final static String URL_START = "https://www.youtube.com/";
        private final static String AFTER_TAG = "?v=";
        private String hash ="";
        ...
        public String getWatchURL(){
            return URL_START + TAG_WATCH + AFTER_TAG + hash;
        }
        public String getEmbeddedURL(){
            return URL_START + TAG_EMBEDDED  + "/" + hash + "?autoplay=1&vq=tiny";
        }
